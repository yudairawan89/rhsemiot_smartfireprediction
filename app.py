...
col_logo1, col_text, col_logo2 = st.columns([3, 6, 3])  # lebih proporsional

with col_logo1:
    st.image("logo.png", width=130)  # bisa ditingkatkan sedikit
...
with col_logo2:
    st.image("upi.png", width=190)  # logo UPI lebih besar
